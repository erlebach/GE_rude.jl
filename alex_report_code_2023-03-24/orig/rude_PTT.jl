...
function tbnn(σ,γd,model_weights,printout)
    ...
    if printout == true
        ...
        print(" ")
        print(round(λ2, digits=num_digits))
        print(" ")
        print(round(λ3, digits=num_digits))
        print(" ")
        print(round(λ4, digits=num_digits))
        print(" ")
        print(round(λ5, digits=num_digits))
        print(" ")
        print(round(λ6, digits=num_digits))
        print(" ")
        print(round(λ7, digits=num_digits))
        print(" ")
        print(round(λ8, digits=num_digits))
        print(" ")
        print(round(λ9, digits=num_digits))
        print(" ==> ")
        print(round(g1, digits=num_digits))
        print(" ")
        print(round(g2, digits=num_digits))
        print(" ")
        print(round(g3, digits=num_digits))
        print(" ")
        print(round(g4, digits=num_digits))
        print(" ")
        print(round(g5, digits=num_digits))
        print(" ")
        print(round(g6, digits=num_digits))
        print(" ")
        print(round(g7, digits=num_digits))
        print(" ")
        print(round(g8, digits=num_digits))
        print(" ")
        println(round(g9, digits=num_digits))
    end
...
function dudt_univ!(du, u, p, t, gradv)
    ...
    F11,F22,F33,F12,F13,F23 = tbnn(u,γd,model_weights,VERBOSE)
...
for k = range(start_at,length(protocols),step=1)
	...
	result_univ = Optimization.solve(optprob, Optimisers.AMSGrad(), callback = cb_fun, maxiters = max_iterations)
...
savefig(final_plot, savedir*"rude_test.pdf")
