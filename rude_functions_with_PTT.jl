...
function dudt_PPT!(du, u, p, t, gradv)
    # Destructure the parameters
    η0 = p[1]
    τ = p[2]
    α = p[3]
	...
	# define lambda
	λ = 1.
	fPPT = exp(ϵ * trace / G) / λ
    F11 = -τ*(σ11*γd11 + σ12*γd12 + σ13*γd13) + fPPT 
    F22 = -τ*(σ12*γd12 + σ22*γd22 + σ23*γd23) + fPPT 
    F33 = -τ*(σ13*γd13 + σ23*γd23 + σ33*γd33) + fPPT 
    F12 = (-τ*(σ11*γd12 + σ12*γd22 + σ13*γd23 + γd11*σ12 + γd12*σ22 + γd13*σ23)/2 + fPPT 
    F13 = (-τ*(σ11*γd13 + σ12*γd23 + σ13*γd33 + γd11*σ13 + γd12*σ23 + γd13*σ33)/2 + fPPT 
    F23 = (-τ*(σ12*γd13 + σ22*γd23 + σ23*γd33 + γd12*σ13 + γd22*σ23 + γd23*σ33)/2 + fPPT 
...
function plot_data!(plots, targetk, target_titlek, sol_ude_pre, sol_ude_post, sol_giesekus, sol_PPT)
